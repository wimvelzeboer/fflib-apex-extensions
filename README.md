...
Either clone the repository and import the package manually, use the [Package Installation URL](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tJ8000000kaKpIAI)
or execute the following SFDX CLI command in your terminal:
```bash
sf package install --package 04tJ8000000kaKpIAI --wait=10 --target-org $YOUR_ORG_ALIAS
```
...
|-----------------------------------------------|--------------------|--------------------------------|
| 0.1.0-2                                       | 04tJ8000000kaKVIAY | Created on 26/03/2026 20:07:07 || 0.5.0.1 | 04tJ8000000kaKpIAI | Created on 30/03/2026 13:17:49 |
