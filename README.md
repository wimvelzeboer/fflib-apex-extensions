...
Either clone the repository and import the package manually, use the [Package Installation URL](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tJ8000000kaL4IAI)
or execute the following SFDX CLI command in your terminal:
```bash
sf package install --package 04tJ8000000kaL4IAI --wait=10 --target-org $YOUR_ORG_ALIAS
```
